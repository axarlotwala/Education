...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recycler_card = view.findViewById(R.id.recycler_card);

        LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity(),LinearLayoutManager.HORIZONTAL,false);

        recycler_card.setLayoutManager(linearLayoutManager);

        Card_apapter card_apapter = new Card_apapter(getActivity(),card_models);
        recycler_card.setAdapter(card_apapter);
        return view;
    }

    private void FetchCardDetail() {
